            ...
            <?php 
             include('connect.php');
                ...
                if(isset($_POST['submit'])){
                    ...
                    $qry= mysqli_query($con, "SELECT * FROM products WHERE `product_name` LIKE '%$searhValue%'");
                    $data=mysqli_query($con,"SELECT count(*) as total from products WHERE `product_name` LIKE '%$searhValue%'");
                    ...
                    if( $r['total'] > 0){
                        ...
                        echo "<div class='card'>";
                        echo "<h1 align='center' style='padding-top: 5%'>Product search not exist.</h1>";
                        echo "</div>";
                    }  
                };

...
<html>
    ...
    <body>
        ...
        <div class="col-12-sm">
        <div class="card">
            <h4 style="text-align: center; padding: 10px; margin-top: 5%;"><i class="fas fa-shopping-cart"></i> My Cart</h4>
            <div class="container">
                  ...
                  <?php 
                        ...
                        if(isset($_SESSION['id'])){
                            ...
                            while ($rows = mysqli_fetch_array($qry)){
                                ...
                                echo"<img class='productImage' src='".$rows['image']."'>  <span style='padding-left: 21%'>".$rows['product_name']." <sup><a href='removeCart.php?cartId=".$rows['id']."'>Remove</a> </sup> </span>";
                                echo"</div>";
                                echo"<div class='item2'>";
                                echo"&#8369; ".number_format((float)$rows['price'],2,'.',',')."";
                                echo"</div>";
                                echo"<div class='item' style=' text-align: center;'>";
                                echo"".$rows['quantity']."";
                                echo"</div>";
                                echo"<div class='item'>";
                                echo"&#8369; ".number_format((float)($rows['price'] * $rows['quantity']),2,'.',',')." ";
                                echo"</div>";
                            }
                            ...
                            if($total != 0){
                                ...
                                echo"</div>";
                                echo"<hr>";
                                echo "<div style='padding: 5px 12px;height: 55px;font-weight: 600;'>";
                                echo "Payment Method : Cash On Delivery";
                                echo " <a class='placeOrder' href='placeOrder.php'> Place Order</a>";
                                echo " </div>";
                            } else {

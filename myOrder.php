...
<html>
    ...
    <body>
        ...
        <div class="col-12-sm">
        <div class="card">
            <h4 style="text-align: center; padding: 10px; margin-top: 5%;"><i class="fas fa-shopping-bag"></i> My Order</h4>
            <div class="container">
                ...
                <hr>
                  ...
                  <?php 
                        ...
                        if(isset($_SESSION['id'])){
                            $userId = $_SESSION['id'];
                            // echo $userId;
                            $qry= mysqli_query($con, "SELECT * FROM placeorder Where userId = $userId");
                            $total = 0;
                            echo"<div class='grid-container'>";
                            while ($rows = mysqli_fetch_array($qry)){
                                $total += ($rows['price'] * $rows['qty']);
                                echo"<div class='item1'>";
                                echo"<img class='productImage' src='".$rows['image']."'>  <span style='padding-left: 21%'>".$rows['product_name']." </span>";
                                echo"</div>";
                                ...
                                echo"</div>";
                                echo"<div class='item'>";
                                echo"&#8369; ".number_format((float)($rows['price'] * $rows['qty']),2,'.',',')." ";
                                echo"</div>";
                            }
